...
- ``base.py`` — :class:`~zotero_mcp.semantic_search.embeddings.base.BaseEmbeddingFunction`, the
...
- ``registry.py`` — the provider registry that maps a configured
  ...
  directly as ``zotero_mcp.semantic_search.embeddings.registry``; deliberately not re-exported
...
from zotero_mcp.semantic_search.embeddings import providers  # noqa: F401
